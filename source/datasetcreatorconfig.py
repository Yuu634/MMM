...
class DatasetCreatorBaseConfig:
    ...
    def __init__(
        ...
        self.datasetSource_path = datasetSource_path
        self.IsAtmosphere = IsAtmosphere
...
#独自データ  
class MyDatasetCreatorTrackConfig(DatasetCreatorBaseConfig):

    def __init__(self, **kwargs):
        super().__init__(
            dataset_name="test3", #保存先ディレクトリ
            datasetSource_path='MyDataset', #学習データセットディレクトリ
